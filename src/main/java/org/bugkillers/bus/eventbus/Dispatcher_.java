...
abstract class Dispatcher_ {
   ...
   */
  static Dispatcher_ perThreadDispatchQueue() {
   ...
   */
  static Dispatcher_ legacyAsync() {
   ...
   */
  abstract void dispatch(Object event, Iterator<Subscriber_> subscribers);

  /**
   * Implementation of a {@link #perThreadDispatchQueue()} dispatcher.
   */
  private static final class PerThreadQueuedDispatcher extends Dispatcher_ {
    ...
    @Override
    void dispatch(Object event, Iterator<Subscriber_> subscribers) {
      checkNotNull(event);
    ...
    private static final class Event {
      ...
      private final Iterator<Subscriber_> subscribers;

      private Event(Object event, Iterator<Subscriber_> subscribers) {
        this.event = event;
   ...
   */
  private static final class LegacyAsyncDispatcher extends Dispatcher_ {
    ...
    private static final class EventWithSubscriber {
      private final Object event;
      private final Subscriber_ subscriber;

      private EventWithSubscriber(Object event, Subscriber_ subscriber) {
        this.event = event;
   ...
   */
  private static final class ImmediateDispatcher extends Dispatcher_ {

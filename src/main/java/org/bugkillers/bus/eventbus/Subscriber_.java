...
class Subscriber_ {
  ...
  private Subscriber_(EventBus_ bus, Object target, Method method) {
    this.bus = bus;
   ...
   */
  private SubscriberExceptionContext_ context(Object event) {
    return new SubscriberExceptionContext_(bus, event, target, method);
  }

 ...
 * @since 16.0
 */
public class SubscriberExceptionContext_ {
  ...
  /**
   * @param eventBus The {@link com.google.common.eventbus.EventBus} that handled the event and the
   ...
   */
  SubscriberExceptionContext_(EventBus_ eventBus, Object event, Object subscriber,
  ...
  /**
   * @return The {@link com.google.common.eventbus.EventBus} that handled the event and the subscriber.
   *     Useful for broadcasting a a new event based on the error.
   */
  public EventBus_ getEventBus() {
    return eventBus;
  }
